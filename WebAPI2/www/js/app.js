...
.controller('SignUpCtrl', function($scope, $state, $http ){
    ...
    $scope.createUser = function(type){ 
        ...
        function addseller(id){
            var request3 = "";
            var peticion3 = "crear/proveedor/"
            peticion3 = peticion3.concat(id,"/",$scope.signUp.Uname.replace(" ","%20"),"/", $scope.signUp.lname1,"/",$scope.signUp.lname2,"/",$scope.signUp.phone,"/",$scope.signUp.inum,"/",$scope.signUp.address.replace(" ","%20"),"/",$scope.signUp.password,"/",$scope.signUp.bdate);
            request3 = request3.concat(ip, peticion3);
            console.log("Request es:", request3);
             $http.get(request3)
                                .then(function (response) {
                                console.log("enty");
                                console.log('Get Post', response);
